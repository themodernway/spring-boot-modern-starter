...
public class SecurityConfiguration
{
    ...
    {
        auth.inMemoryAuthentication().withUser("root").password("fd665330ebb8ee0c00934123651b7d386563a1bca3b9fdfe92a5c548968391b0076ebd9abb25735f9d6aac92f301a57bbde0129c4026bb4c3d47c6b9f575d36c5a825c1badf44ab9741a2ad11e370b4a31e30a36741e241435e19898").authorities("ADMIN", "ACTUATOR", "USER").and().withUser("user").password("7110f603eb824e5a16c43ee2b274f25f66472de65d8708d9937837b663e66880d0041a119fb546a60f7eae5d12a7e45332b435579f0cb6fc26c7eaf030e6662477766ca2889dac602bf1932178e6fd43ce4f54890ae5c0422acb52f2").authorities("USER");
    }
    ...
    public static class ActuatorSecurityConfigurationAdapter extends WebSecurityConfigurerAdapter
    {
        ...
        {
            http.authorizeRequests().antMatchers("/service/**").hasAuthority("USER").requestMatchers(EndpointRequest.toAnyEndpoint()).hasAuthority("ACTUATOR").anyRequest().authenticated().and().httpBasic().and().csrf().disable();
        }
    }
